...
const UsageSummary = () => {
  ...
  // Unique key for storing filter data specific to UsageSummary
  ...
  if (Role === 'client' && !BillingAccount?.id) {
    return <div className="container usage-summary"><h1 className="message">No billing account found.</h1></div>;
  }
